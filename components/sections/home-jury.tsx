...
function JuryCard({
  ...
  return (
    <article
      data-slot="jury-card"
      className={`group relative flex min-h-[6.25rem] items-start gap-4 px-[6px] py-[1.3125rem] transition-colors duration-500 lg:aspect-square lg:min-h-0 lg:items-center lg:border-r lg:px-8 lg:py-5 lg:text-center lg:hover:bg-brand-ink ${knownPhoto ? "lg:justify-center" : "lg:justify-end lg:pb-6"} ${withoutHorizontalStroke ? "" : "border-b border-brand-ink/20"}`}
    >
      {knownPhoto && (
        <Image
          src={knownPhoto}
